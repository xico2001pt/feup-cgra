...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setDiffuse(0.5098, 0.28627, 0.043, 1.0);
        this.material4.setSpecular(0.5098, 0.28627, 0.043, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(0.3 * this.globalLightIntensity, 0.3 * this.globalLightIntensity, 0.3 * this.globalLightIntensity, 1.0);
